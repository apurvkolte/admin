...
// const ReactApexChart = React.lazy(()=>import('react-apexcharts'), { ssr: false })
...
const user10 = "/assets/img/users/10.jpg";
const user11 = "/assets/img/users/11.jpg";
const user12 = "/assets/img/users/12.jpg";
const work3 = "/assets/img/pngs/work3.png";
const work = "/assets/img/pngs/work.png";
const projectlogo = "/assets/img/media/project-logo.png"
...
const TodayTask = React.lazy(() => import('../../shared/data/dashboard/today-task'), { ssr: false })
          ...
          <div className="card custom-card">
            <div className="card-body">
              <div className="row row-sm">
                ...
                <div className="col-6">
                  <img src={work} alt="image" className="best-emp" />
                </div>
              </div>
            </div>
          </div>
