...
const FromInlineEditEditor = React.lazy(() => import('../../shared/data/forms/formEditers/FromInlineEditEditor'), { ssr: false })
const Modalineditor = React.lazy(() => import('../../shared/data/forms/formEditers/Modalineditor'), { ssr: false })
const Wrappers = React.lazy(() => import('../../shared/data/forms/formEditers/Wrappers'), { ssr: false })
