...
//Images
const watch2 = "/assets/img/pngs/shirt-2.png";
const watch3 = "/assets/img/pngs/shirt-3.png";
const watch4 = "/assets/img/pngs/shirt-4.png";
const watch5 = "/assets/img/pngs/shirt-5.png";
...
const ProductDetails = () => {
	...
	const [img, setimg] = useState(watch2)
													...
													<div id="thumbcarousel" className="carousel slide" data-bs-interval="false">
														<div className="carousel-inner">
															<div className="carousel-item active">
																<div data-bs-target="#carousel" data-bs-slide-to="0" className="thumb my-2" onClick={() => { setimg(watch2) }}><img src={watch2} alt="img" /></div>
																<div data-bs-target="#carousel" data-bs-slide-to="1" className="thumb my-2" onClick={() => { setimg(watch3) }}><img src={watch3} alt="img" /></div>
																<div data-bs-target="#carousel" data-bs-slide-to="2" className="thumb my-2" onClick={() => { setimg(watch4) }}><img src={watch4} alt="img" /></div>
																<div data-bs-target="#carousel" data-bs-slide-to="3" className="thumb my-2" onClick={() => { setimg(watch5) }}><img src={watch5} alt="img" /></div>
															</div>
														</div>
													</div>
												</div>
													...
													<div className="card-body p-0">
															...
															<div className="d-flex me-3">
																<a href="#!">
																	<div className="media-image avatar avatar-md rounded-circle" >
																		<img className="media-image avatar avatar-md rounded-circle" alt="64x64" src={users8} />
																	</div>
																</a>
															</div>
															...
															<div className="d-flex me-3">
																<a href="#!">
																	<span className="media-image avatar avatar-md rounded-circle">
																		<img alt="64x64" src={users3} className="media-image avatar avatar-md rounded-circle" />
																	</span>
																</a>
															</div>
															<div className="media-body">
														...
														<div className="media mt-0 p-4 border-bottom">
															<div className="d-flex me-3">
																<a href="#!">
																	<span className="media-image avatar avatar-md rounded-circle">
																		<img className="media-image avatar avatar-md rounded-circle" alt="64x64" src={users5} />
																	</span>
																</a>
															</div>
															<div className="media-body">
