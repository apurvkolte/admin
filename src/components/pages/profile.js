...
const Gallery2 = React.lazy(() => import('../../shared/data/pages/gallery'), { ssr: false })
                            ...
                            <div className="col-12">
                              <Card className=" mg-b-20 border">
                                  ...
                                  <div className="media">
                                    <div className="media-user me-2">
                                      <div className="main-img-user avatar-md">
                                        <img alt="user6" className="rounded-circle" src={users2} />
                                      </div>
                                    </div>
                                    <div className="media-body">
                                ...
                                <Card.Body>
                                  ...
                                  <Row className=" row-sm">
                                    <div className="col">
                                      <img alt="img" className="wd-200 m-2" src={media3} />
                                      <img alt="img" className="wd-200 m-2" src={media11} />
                                    </div>
                                  </Row>
                              ...
                              <Card className=" mg-b-20 border">
                                <Card.Header className="p-4">
                                  <div className="media">
                                    <div className="media-user me-2">
                                      <div className="main-img-user avatar-md">
                                        <img alt="user6" className="rounded-circle" src={users6} />
                                      </div>
                                    </div>
                                    <div className="media-body">
                                      <h6 className="mb-0 mg-t-2 ms-2">
                                ...
                                <Card.Body>
                                  ...
                                  <Row className=" row-sm">
                                    <div className="col">
                                      <img alt="img" className="wd-200 m-2" src={media2} />
                                      <img alt="img" className="wd-200 m-2" src={media12} />
                                    </div>
                                  </Row>
                                  <div className="media mg-t-15 profile-footer">
                                    <div className="media-user me-2">
                              ...
                              <Card className="border">
                                <Card.Header className="p-4">
                                  <div className="media">
                                    <div className="media-user me-2">
                                      <div className="main-img-user avatar-md"><img alt="user2" className="rounded-circle" src={users2} /></div>
                                    </div>
                                    <div className="media-body">
                                ...
                                <Card.Body className="h-100">
                                  ...
                                  <Row className="row row-sm">
                                    <div className="col">
                                      <img alt="img" className="wd-200 m-2" src={media4} />
                                      <img alt="img" className="wd-200 m-2" src={media7} /> </div>
                                  </Row>
                                  <div className="media mg-t-15 profile-footer">
                                    <div className="media-user me-2">
                                      <div className="demo-avatar-group">
                                        <div className="demo-avatar-group main-avatar-list-stacked">
                                          <div className="main-img-user online"><img alt="user11" className="rounded-circle" src={users11} /></div>
                                          <div className="main-img-user"><img alt="user12" className="rounded-circle" src={users12} /></div>
                                          <div className="main-img-user"><img alt="user4" className="rounded-circle" src={users4} /></div>
                                          <div className="main-img-user online"><img alt="user5" className="rounded-circle" src={users5} /></div>
                        ...
                        <Card className="custom-card border">
                          <div className=" text-center">
                            <div className="user-lock text-center">
                              ...
                              <Link to="#!">
                                <img alt="avatar" className="rounded-circle" src={users2} />
                              </Link>
                            </div>
                            <Link to="#!">
                              <h5 className=" mb-1 mt-3 main-content-label">
                        ...
                        <Card className="custom-card border">
                          <div className=" text-center">
                            <div className="user-lock text-center">
                              ...
                              <Link to="#!">
                                <img src={users1} className="rounded-circle" alt="img" />
                              </Link>
                            </div>
                            <Link to="#!">
                              <h5 className="mb-1 mt-3  main-content-label">
