...
//Images
const team = "/assets/img/media/team.jpg"
            ...
            <Row className="row-sm">
              <Col xl={6} lg={6} md={12} sm={12}>
                <div className="mt-5">
                  ...
                  <Link to="#!" className="btn ripple btn-primary btn-sm" role="button">
                    Contact Us
                  </Link>
                </div>
              </Col>
              <Col xl={6} lg={6} md={12} sm={12}>
                <div className="text-xl-end text-center">
                  <img src={team} alt="img" className="rounded-5" />
                </div>
              </Col>
            </Row>
          </Col>
        ...
        <Row className="row-sm">
          ...
          <Col xl={3} lg={6} md={6} sm={6}>
            <Card className="custom-card our-team">
              <Card.Body>
                <div className="picture avatar-lg online text-center">
                  <img alt="avatar" className="rounded-circle" src={users6} />
                </div>
                <div className="text-center mt-3">
                  <Link to="#!">
          ...
          <Col xl={3} lg={6} md={6} sm={6}>
            <Card className="custom-card our-team">
              <Card.Body>
                <div className="picture avatar-lg online text-center">
                  <img alt="avatar" className="rounded-circle" src={users7} />
                </div>
                <div className="text-center mt-3">
                  <Link to="#!">
                    <h5 className="pro-user-username text-dark mt-2 mb-0">
