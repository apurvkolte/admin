...
const qrcode = "/assets/img/pngs/qrcode.png";
      ...
      <div>
        ...
        <Row className="row-sm">
          <Col xxl={4} xl={12} lg={12} md={12}>
            ...
            p-3">
                <div className="d-flex">
                  <img src={btc} alt="img" className="wd-30 ht-30 new-me-3 my-auto" />
                  <div className="mt-1">
                ...
                <Row className="mt-3">
                  ...
                  <Col>
                    ...
                    <Link to="#!" className="btn btn-white border btn-block btn-square">
                      Network Transfer
                    </Link>
                  </Col>
                </Row>
              ...
              <Card.Body>
                ...
                <Row className="row mt-3 crypto-wallet">
                  ...
                  <Col md={2} className=" col-md-2">
                    <img
                      src={qrcode} className="ht-100 float-end mb-2 mt-2"
                      alt="qrcode"
                    />
                  </Col>
                </Row>
