...
const SlotCounter = React.lazy(() => import('react-slot-counter'), { ssr: false });
import {
  Button,
  Card,
  Col,
...
const market3 = "/assets/landing/images/market3.png";
const frequentlyaskedquestions = "/assets/landing/images/frequently-asked-questions.png";
const Landingpagecom = React.lazy(() => import('../../shared/data/landingpagedata/landingpagecom'), { ssr: false })
                ...
                <div className="main-header-center">
                  <div className="responsive-logo">
                    <Link to={`/components/dashboard/dashboard`}>
                      <img src={logo} className="mobile-logo" alt="lo/o" />
                    </Link>
                    <Link to={`/components/dashboard/dashboard`}>
                      <img
                        src={logolight}
                      ...
                      <section className="sptb demo-screen-demo">
                        <Row className="align-items-center">
                          ...
                          <Col md={12} lg={6} className="reveal revealright">
                            <img src={frequentlyaskedquestions} alt="w" />
                          </Col>
                        </Row>
                      </section>
                    </Row>
