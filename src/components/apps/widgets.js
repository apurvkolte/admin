                ...
                <div className="row align-items-center justify-content-center">
                  <div className="col-auto user-lock">
                    <span className="img-fluid rounded-circle">
                      <img className="img-fluid rounded-circle" src={user8} alt="avatar" />
                    </span>
                  </div>
                  <div className="col">
                    <h5>Joyce Chua</h5>
