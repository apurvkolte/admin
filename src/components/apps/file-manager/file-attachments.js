...
const blog9 = "/assets/img/media/blog9.jpg"
const blog8 = "/assets/img/media/blog8.jpg"
                                ...
                                <Card.Body>
                                    ...
                                    <div className="h-100  attached-file-grid6">
                                        <div className="pro-img-box attached-file-image">
                                            <Link href="#!">
                                                <img className=" pic-1 pos-relative rounded-5 w-100" src={blog5} alt="blog5" /><span className="image-pic">123image.jpg</span>
                                            </Link>
                                            <ul className="icons">
                            ...
                            <Card className="custom-card">
                                <Card.Body>
                                    ...
                                    <div className="h-100  attached-file-grid6">
                                        <div className="pro-img-box attached-file-image">
                                            <Link to="#!">
                                                <img className=" pic-1 pos-relative rounded-5 w-100" src={blog6} alt="blog6" /><span className="image-pic">123image.jpg</span>
                                            </Link>
                                            <ul className="icons">
                            ...
                            <Card className="custom-card">
                                <Card.Body>
                                    ...
                                    <div className="h-100  attached-file-grid6">
                                        <div className="pro-img-box attached-file-image">
                                            <Link to="#!">
                                                <img className=" pic-1 pos-relative rounded-5 w-100" src={blog9} alt="blog9" /><span className="image-pic">123image.jpg</span>
                                            </Link>
                                            <ul className="icons">
                                                <li className="me-1"><Link href="#!" data-placement="top" data-bs-toggle="tooltip" title="download"><i className="fe fe-download"></i></Link></li>
                                                <li className="me-1"><Link href="#!" data-placement="top" data-bs-toggle="tooltip" title="delete"><i className="fe fe-trash"></i></Link></li>
                            ...
                            <Card className="custom-card">
                                <Card.Body>
                                    ...
                                    <div className="h-100  attached-file-grid6">
                                        <div className="pro-img-box attached-file-image">
                                            <Link to="#!">
                                                <img className=" pic-1 pos-relative rounded-5 w-100" src={blog8} alt="blog8" /><span className="image-pic">123image.jpg</span>
                                            </Link>
                                            <ul className="icons">
                                                <li className="me-1"><Link href="#!" data-placement="top" data-bs-toggle="tooltip" title="download"><i className="fe fe-download"></i></Link></li>
                                                <li className="me-1"><Link href="#!" data-placement="top" data-bs-toggle="tooltip" title="delete"><i className="fe fe-trash"></i></Link></li>
