...
const user18 = "/assets/img/media/18.jpg"
const user19 = "/assets/img/media/19.jpg"
const user20 = "/assets/img/media/20.jpg"
        ...
        <Row className="row-sm">
          <Col lg={4} xl={3} md={12}>
            <Card className="custom-card">
              <Card.Body>
                <div>
                  <Link to="/components/apps/mail/mail-compose"
                    variant="primary"
                    id="btnCompose"
          ...
          <Col lg={8} xl={9} md={12}>
            <Card className="custom-card">
              ...
              <Card.Footer>
                ...
                <Link to="#!" className="btn ripple btn-secondary mt-1 mb-1 me-1">
