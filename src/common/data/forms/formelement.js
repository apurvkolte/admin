...
const Searchable = React.lazy(() => import('react-searchable-dropdown'), {
  ssr: false
})
...
const Pickr = React.lazy(() => import('@simonwep/pickr'), {
  ssr: false
})
const MaskInput = React.lazy(() => import('react-maskinput'), {
  ssr: false
})
